...
def raw_data(height = 1, width = 1):
    ...
    data_items = [['Start', chr(ord('A') + y_start), x_start + 1, variant]]
...
# its default width and height (8 x 6 cells). 
#
...
#
#    seed 2: 8 steps with variant C visible on the first row
#    seed 31: 2 steps with no "moves"
#    seed 32: 10 steps with variants C and A visible at the end
#    seed 43: 5 steps with only variants B and D visible at the end
#    seed 49: 9 steps with variants A and D
#    seed 57: 6 steps with variant A only (no changes)
#    seed 104: 3 steps with only 'zero moves'
#    seed 113: 4 steps with variant D only (no changes)
#    seed 123: 7 steps with variants C and D visible at the end
#    seed 139: 1 step with variant A only
#    seed 162: 7 steps with only variant B visible at the end
#    seed 165: 3 steps with variants B and D 
#    seed 174: 1 step with variant D only
#    seed 176: 4 steps with only variant A visible at the end
#    seed 190: 10 steps with variants C and D
